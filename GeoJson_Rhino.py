...
def processGeoJson(parsedGeoJson, destinationLayer=None, destinationLayerColor=System.Drawing.Color.Black):
    # get the features
...
def load(rawJsonData, destinationLayer=None, destinationLayerColor=System.Drawing.Color.Black):
